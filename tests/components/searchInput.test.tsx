...
describe("DB Card test", () => {
    test("Should render correctly", () => {
        const {container} =  render(<SearchInput defaultValue={{}}  onInputChange={(e) => ({})} onTypeChange={(e) => ({})}/>);
    ...
    test("Should call fn when input change", () => {
        ...
        const {container} =  render(<SearchInput defaultValue={{}}  onInputChange={onInputChange} onTypeChange={onTypeChange}/>);
